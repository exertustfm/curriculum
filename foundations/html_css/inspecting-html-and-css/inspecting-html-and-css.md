...
To open up the inspector, you can right-click on any element of a webpage and click "Inspect Element" or press F12. For example, if you right-click "The Inspector" heading above this paragraph and open the inspector, you might see something that looks a little bit like the image below.

![Chrome Inspector](https://github.com/exertustfm/curriculum/blob/html_css_inspection_lesson_rewrite/foundations/html_css/inspecting-html-and-css/imgs/06.png)
